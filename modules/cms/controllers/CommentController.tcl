...
nx::Class create CommentController  -superclass Controller {
	#variable layout
 ...
 :public method accessRules {} {
	...
	:public method actionApprove {} {
		set id [ns_get id ]
		set approve [ns_get approve ]

		if {$approve ni "1 2"} { ns_puts "Approve is Not ok" }
		if {[set model [my loadModel $id]] ==0} { return }
			$model set status $approve	
			if {[$model save]} {
				my redirect index 
				return 1
			}
