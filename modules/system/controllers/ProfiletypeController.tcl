...
nx::Class create ProfiletypeController -superclass Controller {
	#variable layout
	...
	:public method accessRules {} {
		...
		return [dict create views { 
			...
			update { allow { users @ } roles { admin} }
			create { allow { users @ } roles {  admin} }
			delete { allow { users @ } roles { admin} }
